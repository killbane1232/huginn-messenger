...
func ParseKeyFile(data []byte) (ed25519.PublicKey, ed25519.PrivateKey, []byte, []byte, error) {
	var kf KeyFile
...
func FormatKeyFile(signPub ed25519.PublicKey, signPriv ed25519.PrivateKey, encPriv, encPub []byte) ([]byte, error) {
	kf := KeyFile{
